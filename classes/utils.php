...
class utils
{
    ...
    public static function get_insert_options()
    {
        return array(
           ...
           //TinyMCE in Moodle has not had audio and video set in extended_valid_elements
    ...
    public static function fetch_token_for_display($apiuser,$apisecret){
        ...
        //refresh token
        $refresh = \html_writer::link($CFG->wwwroot . '/lib/editor/tinymce/plugins/cloudpoodll/refreshtoken.php',
