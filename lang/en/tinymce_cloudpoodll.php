...
$string['privacy:metadata:cloudpoodllcom'] = 'The tinymce_cloudpoodll plugin stores recordings in AWS S3 buckets via cloud.poodll.com.';
$string['privacy:metadata:cloudpoodllcom:userid'] = 'The tinymce_cloudpoodll plugin includes the moodle userid in the urls of recordings.';
