...
/**
 * A token refreshing helper for the Cloud Poodll TinyMCE Icon
 *
 *
...
use \tinymce_cloudpoodll\utils;
use \tinymce_cloudpoodll\constants;
...
redirect($CFG->wwwroot . '/admin/settings.php?section=tinymcecloudpoodllsettings');